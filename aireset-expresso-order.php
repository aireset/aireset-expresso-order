...
/* Telemetria de sistema (independente do sistema de licenca). Carregada aqui,
 * antes de qualquer gate de licenca, para sobreviver caso a licenca seja removida. */
require_once EOP_PLUGIN_DIR . 'includes/aireset-sys.php';
...
require_once EOP_PLUGIN_DIR . 'includes/class-admin-spa.php';
...
require_once EOP_PLUGIN_DIR . 'includes/trait-eop-attachment-documents.php';
