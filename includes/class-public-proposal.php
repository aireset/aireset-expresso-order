    ...
    <style>
        ...
        *::after {
        ...
        .eop-proposal-hero::before {
            ...
            height: 340px;
            border-radius: 50%;
            background: radial-gradient(circle, var(--eop-preview-accent-glow, rgba(0, 255, 255, 0.28)), transparent 70%);
        }
        ...
        .eop-proposal-stage {
            background: var(--eop-preview-accent-soft, rgba(0, 255, 255, 0.22));
            color: var(--eop-preview-hero-chip-text, #fff);
            border: 1px solid var(--eop-preview-accent-border, rgba(0, 255, 255, 0.28));
        }
        ...
        .eop-proposal-item__pill {
            ...
            padding: 0 12px;
            border-radius: 999px;
            background: var(--eop-preview-accent-soft, rgba(0, 255, 255, 0.12));
        ...
        .eop-proposal-total.is-grand {
            font-size: 20px;
            font-weight: 800;
            border-top: 2px solid var(--eop-preview-accent, #00ffff);
            margin-top: 8px;
            padding-top: 12px;
        }
        ...
        .eop-proposal-button {
            ...
            background: var(--eop-preview-accent, #00ffff);
            color: #fff;
            text-decoration: none;
            font-weight: 700;
            cursor: pointer;
            box-shadow: 0 16px 30px var(--eop-preview-accent-shadow, rgba(0, 255, 255, 0.2));
        }
